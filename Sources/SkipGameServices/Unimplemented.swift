...
// MARK: - GKAccessPoint (GKAccessPoint.swift header)
...
public final class GKAccessPoint: NSObject {
    @available(*, unavailable)
    public class var shared: GKAccessPoint { fatalError() }
    ...
    @available(*, unavailable)
    public var isVisible: Bool { fatalError() }

    @available(*, unavailable)
    public var isPresentingGameCenter: Bool { fatalError() }
    ...
    @available(*, unavailable)
    public var location: GKAccessPoint.Location {
        get { fatalError() }
        set { fatalError() }
    }

    @available(*, unavailable)
    public var frameInScreenCoordinates: CGRect { fatalError() }

    #if false // UIWindow is not bridged for Skip/Kotlin in this surface.
    @available(*, unavailable)
    weak public var parentWindow: UIWindow? {
        get { fatalError() }
        set { fatalError() }
    }
    #endif
    ...
    @available(*, unavailable)
    public func trigger(handler: @escaping () -> Void) { fatalError() }

    @available(*, unavailable)
    public func trigger(state: GKGameCenterViewControllerState, handler: @escaping () -> Void) { fatalError() }

    #if false // signature clash with async companion.
    @available(*, unavailable)
    public func trigger(achievementID: String, handler: @escaping () -> Void) { fatalError() }
    #endif

    #if false // signature clash with async companion.
    @available(*, unavailable)
    public func trigger(leaderboardSetID: String, handler: @escaping () -> Void) { fatalError() }
    #endif
    ...
    @available(*, unavailable)
    public func trigger(player: GKPlayer, handler: @escaping () -> Void) { fatalError() }
